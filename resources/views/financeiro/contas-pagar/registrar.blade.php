...
@section('content')
    <div class="col-md-12">
        <h2 class="pb-2 display-5">Contas a pagar</h2>
    </div>
    <div class="col-md-12" style="margin-bottom: 10px;">
        <div class="d-flex justify-content-end">
            <a href="{{ route('financeiro.contas-pagar.listagem') }}" class="btn btn-secondary"><i
    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            ...
            <div class="card-body card-block">
                <form id="stepperForm" method="POST" action="{{ route('financeiro.contas-pagar.salvar') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-4">
